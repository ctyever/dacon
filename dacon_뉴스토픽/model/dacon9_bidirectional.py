...
from tensorflow.keras.layers import Dense, Input, LSTM, Conv1D, Flatten, Bidirectional
...
model = Sequential()
                 # 단어사전의 개수                   단어수, 길이
model.add(Embedding(input_dim=2000, output_dim=128, input_length=14))
...
model.fit(x_train, y_train, epochs=1000, batch_size=256, validation_split=0.1, callbacks=[es, mcp])
end_time = time.time() - start_time

# model = load_model('./_save/dacon0803_2346_.0002-0.6322.hdf5')
