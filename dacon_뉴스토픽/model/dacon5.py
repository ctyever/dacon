...
# model.fit(x_train, y_train, epochs=100, batch_size=256, validation_split=0.1, callbacks=[es, mcp])
# end_time = time.time() - start_time

model = load_model('./_save/dacon0803_2305_.0003-0.6580.hdf5')
...
10차 / dacon0802_2357_.0002-0.6495 / 정답률 제일 높음
